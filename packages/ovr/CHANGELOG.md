...
- cf7d0ac: feat(jsx): Support XML rendering
...
- cf7d0ac: fix(types): `Context.json` no longer accepts `bigint` as an input since `bigint` cannot be passed into `JSON.stringify`.
